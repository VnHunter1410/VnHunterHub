...
local thuoclaonghean = Instance.new("Sound")
thuoclaonghean.Name = "JoinSound"
thuoclaonghean.SoundId = "rbxassetid://118247947701joinSound.Parent" -- ID nhạc khi chạy mã
thuoclaonghean.Volume = 5
thuoclaonghean.Looped = true
thuoclaonghean.Parent = workspace
Notification("<Color=Red>Subscribe to VnHunter <Color=/>"):Display();
wait(0.5);
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=133030139299366";
v24.Parent = v23;
