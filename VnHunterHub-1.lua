...
elseif (v18 == 7449423635) then
    ...
    game.Players.LocalPlayer.Kick("Không Hỗ Trợ Game Này!")
end
...
local v50 = v16.Main:AddToggle("ToggleMobAura", {
    Title = "Đấm Quái Gần/Farm Near Mob",
    Description = "",
    Default = false
});
...
local v51 = v16.Main:AddToggle("ToggleCastleRaid", {
    Title = "Đấm Hải Tặc/Auto Castle Raid",
    Description = "",
    Default = false
});
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Bật Haki Màu Pháo Đài/Haki Fortress",
    Description = "",
    Default = false
});
...
local v55 = v16.Main:AddToggle("ToggleCollectChest", {
    Title = "Lụm Rương/Auto Collect Chest",
    Description = "",
    Default = false
});
...
local v57 = v16.Main:AddDropdown("DropdownMastery", {
    Title = "Chọn chế độ/Choose mode",
    Description = "",
    Values = {
        "Đánh Quái Gần/Near Mob"
    },
    Multi = false,
    Default = 1
});
...
local v58 = v16.Main:AddToggle("ToggleMasteryFruit", {
    Title = "Cày Trái/Farm Fruit Mastery",
    Description = "",
    Default = false
});
...
if Sea3 then
    local v484 = v16.Main:AddSection("Xương/Bone");
    local v485 = v16.Main:AddParagraph({
        Title = "Số Xương/Bone(s)",
        Content = ""
    });
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Mày Có/You have: " .. tostring(v768) .. " Xương/bones");
            end
        end);
    end);
    local v486 = v16.Main:AddToggle("ToggleBone", {
        Title = "Cày Xương/Farm Bones",
        Description = "",
        Default = false
    });
...
if Sea3 then
    local v490 = v16.Main:AddSection("Tư Lệnh Bánh/Cake Prince");
        ...
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("Còn/Kill: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
    ...
    local v492 = v16.Main:AddToggle("ToggleCake", {
        Title = "Cày Tư Lệnh Bánh/Farm Cake Prince",
        Description = "",
        Default = false
    });
    local v493 = true;
    ...
    local v494 = v16.Main:AddToggle("ToggleDoughKing", {
        Title = "Đấm Vua Bột/Farm Dough King",
        Description = "",
        Default = false
    });
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        Title = "Triệu Hồi Tư Lệnh Bánh/Spawn Cake Prince",
        Description = "",
        Default = true
    });
...
if Sea2 then
    ...
    local v497 = v16.Main:AddToggle("ToggleVatChatKiDi", {
        Title = "Auto Farm Ectoplasm/Cày Vật Chất Kì Dị",
        Description = "",
        Default = false
    });
...
local v63 = v16.Main:AddSection("Nguyên Liệu/Ingredients");
if Sea1 then
    MaterialList = {
        "Scrap Metal",
        "Leather",
...
local v64 = v16.Main:AddDropdown("DropdownMaterial", {
    Title = "Chọn Nguyên Liệu/Choose Ingredients",
    Description = "",
    Values = MaterialList,
    Multi = false,
    Default = 1
...
local v65 = v16.Main:AddToggle("ToggleMaterial", {
    Title = "Cày Nguyên Liệu/Farm Ingredients",
    Description = "",
    Default = false
});
...
if Sea3 then
    ...
    local v500 = v16.Sea:AddToggle("ToggleEspKitsune", {
        Title = "Định Vị Đảo Cáo/Esp Kitsune Island",
        Description = "",
        Default = false
    });
    ...
    local v501 = v16.Sea:AddToggle("ToggleTPKitsune", {
        Title = "Bay Vô Đảo Cáo/TP To Kitsune Island",
        Description = "",
        Default = false
    });
    ...
    local v502 = v16.Sea:AddToggle("ToggleCollectAzure", {
        Title = "Lụm Linh Hồn Xanh/Collect Azure Ember",
        Description = "",
        Default = false
    });
...
v16.Sea:AddButton({
    Title = "Đổi Linh Hồn Xanh/Trade Azure Ember",
    Description = "",
    Callback = function()
...
if Sea3 then
    local v503 = v16.Sea:AddSection("Biển/Sea");
    ...
    local v509 = v16.Sea:AddSlider("SliderSpeedBoat", {
        Title = "Tốc Độ Thuyền/Boat Speed",
        Description = "",
        Default = v508,
        Min = 0,
        Max = 350,
    ...
    local v510 = v16.Sea:AddToggle("AutoFindPrehistoric", {
        Title = "Tìm Đảo Dung Nham/Find Prehistoric Island",
        Description = "",
        Default = false
    });
    ...
    local v514 = v16.Sea:AddToggle("AutoFindMirage", {
        Title = "Tìm Đảo Bí Ẩn/Find Mirage Island",
        Description = "",
        Default = false
    });
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        Title = "Tìm Đảo Leviathan/Find Leviathan",
        Description = "K bt có cần 5 người hay k/Need 5 player or idk",
        Default = false
    });
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Trạng thái/Status",
                    Content = "Tìm Thấy Đảo Leviathan/Found Leviathan",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        Title = "Lái Thuyền Về Đảo Tiki/Drive Boat to Tiki",
        Description = "",
        Default = false
    });
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        Title = "Lái Thuyền Về Đảo Hydra/Drive Boat to Hydra Island",
        Description = "",
        Default = false
    });
    ...
    v16.Sea:AddButton({
        Title = "Bay Đến Thuyền/TP To Boat",
        Description = "Duy Nhất Thuyền Bạn Mua Ở Chỗ Chọn/Only Boat you buy in dropdown",
        Callback = function()
            v521();
        end
    });
    local v522 = v16.Sea:AddToggle("ToggleTerrorshark", {
        Title = "Đấm Cá Mập/Farm Terrorshark",
        Description = "",
        Default = false
    });
    ...
    local v523 = v16.Sea:AddToggle("TogglePiranha", {
        Title = "Đấm Piranha/Farm Piranha",
        Description = "",
        Default = false
    });
    ...
    local v525 = v16.Sea:AddToggle("ToggleFishCrew", {
        Title = "Đấm Tàu Cá/Farm Fish Crew",
        Description = "",
        Default = false
    });
    ...
    local v527 = v16.Sea:AddToggle("ToggleGhostShip", {
        Title = "Đấm Tàu Ma/Farm Ghost Ship",
        Description = "",
        Default = false
    });
...
if Sea3 then
    local v531 = v16.Sea:AddSection("Đảo Bí Ẩn/Mirage Island");
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("Đảo Bí Ẩn/Mirage Island: " .. MirageStatus .. " | Trăng Tròn/Full Moon: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
        Title = "Bay Đến Chỗ Cao/TP Tp Highest Point",
        Description = "",
        Callback = function()
            TweenToHighestPoint();
        end
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Bay Đến Advanced Fruit Dealer/TP To Advanced Fruit Dealer",
    Description = "",
    Default = false
});
...
local v67 = v16.Sea:AddToggle("ToggleTweenGear", {
    Title = "Bay Đến Bánh Răng/Tween Gear",
    Description = "",
    Default = false
});
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    Title = "Nhìn Trăng Và Dùng Tộc/Look Moon and Use Race V3",
    Description = "",
    Default = false
});
...
local v76 = v16.ITM:AddToggle("ToggleAutoMusketeerHat", {
    Title = "Mũ Lính Ngự Lâm/Musketeer Hat",
    Description = "",
    Default = false
});
...
local v77 = v16.ITM:AddToggle("ToggleAutoObservationV2", {
    Title = "Haki Quan Sát V2/Observation V2",
    Description = "",
    Default = false
});
...
local v82 = v16.ITM:AddToggle("ToggleAutoDualKatana", {
    Title = "Song Kiếm/Cursed Dual Katana",
    Description = "",
    Default = false
});
...
if Sea2 then
    local v537 = v16.ITM:AddToggle("ToggleFactory", {
        Title = "Đấm Nhà Máy/Farm Factory",
        Description = "",
        Default = false
    });
...
if (Sea2 or Sea3) then
    local v538 = v16.ITM:AddToggle("ToggleHakiColor", {
        Title = "Mua Màu Haki/Buy Haki Color",
        Description = "",
        Default = false
    });
...
if Sea2 then
    local v539 = v16.Main:AddToggle("ToggleSwordLengend", {
        Title = "Mua Kiếm Huyền Thoại/Buy Legendary Sword",
        Description = "",
        Default = false
    });
...
if Sea2 then
    local v540 = v16.Main:AddToggle("ToggleEvoRace", {
        Title = "Nâng Tộc V2/Evolve Race V2",
        Description = "",
        Default = false
    });
...
local v87 = v16.Setting:AddToggle("ToggleAutoKen", {
    Title = "Bật Haki Quan Sát/Auto Observation",
    Description = "",
    Default = false
});
...
local v88 = v16.Setting:AddToggle("ToggleSaveSpawn", {
    Title = "Lưu Điểm Hồi Sinh/Set Spawnpoint",
    Description = "",
    Default = false
});
...
local v91 = v16.Setting:AddToggle("ToggleRemoveNotify", {
    Title = "Xóa Thông Báo/Remove Notification",
    Description = "",
    Default = false
});
...
local v92 = v16.Setting:AddToggle("ToggleWhite", {
    Title = "Màn Hình Trắng/White Screen",
    Description = "",
    Default = false
});
...
local v93 = v16.Setting:AddSection("Kĩ Năng Thông Thạo/Skills");
local v94 = v16.Setting:AddToggle("ToggleZ", {
    Title = "Kĩ Năng Z/Skill Z",
    Description = "",
    Default = true
});
...
local v102 = v16.Status:AddParagraph({
    Title = "Thời Gian Máy Chủ/Server Time",
    Content = ""
});
local function v103()
...
v16.Status:AddButton({
    Title = "Bắt Đầu Tham Gia Job ID/Join Job ID",
    Description = "",
    Callback = function()
...
v16.Status:AddButton({
    Title = "Sao Chép Job ID/Copy Job ID",
    Description = "",
    Callback = function()
...
local v106 = v16.Status:AddToggle("MyToggle", {
    Title = "Spam Tham Gia Job ID/Spam Join Job ID",
    Default = false
});
...
local v113 = v16.Player:AddDropdown("SelectedPly", {
    Title = "Chọn Người Chơi/Choose Player",
    Description = "",
    Values = v112,
    Multi = false,
    Default = 1
...
v16.Player:AddButton({
    Title = "Tải Lại Người Chơi/Refresh",
    Description = "",
    Callback = function()
        table.clear(v112);
...
local v114 = v16.Player:AddToggle("ToggleTeleport", {
    Title = "Bay Đến Người Chơi/TP To Player",
    Description = "",
    Default = false
});
...
local v56 = v16.Player:AddSection("Khác/Other");
...
local v116 = v16.Player:AddToggle("ToggleWalkonWater", {
    Title = "Đi Trên Nước/Walk On Water",
    Description = "",
    Default = true
});
...
local v118 = v16.Teleport:AddSection("Thế Giới/World");
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    Title = "Nhiệm Vụ Qua Biển 2/Auto Sea 2",
    Description = "",
    Default = false
});
...
local v120 = v16.Teleport:AddToggle("ToggleAutoSea3", {
    Title = "Nhiệm Vụ Qua Biển 3/Auto Sea 3",
    Description = "",
    Default = false
});
...
local v56 = v16.Teleport:AddSection("Đảo/Islands");
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
v16.Teleport:AddButton({
    Title = "Bay Đến Đảo/TP to Island",
    Description = "",
    Callback = function()
...
v16.Visual:AddInput("Input_Fragments", {
    Title = "Điểm F/Fragments",
    Default = "",
    Placeholder = "Nhập/Put Fragments",
    Numeric = false,
    Finished = false,
...
local v124 = v16.Fruit:AddDropdown("DropdownPermanentFruit", {
    Title = "Chọn Trái Vĩnh Viễn/Choose Perm Fruit",
    Description = "",
    Values = Table_DevilFruitSniper,
    Multi = false,
    Default = 1
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    Title = "Đổi Trái Vĩnh Viễn/Switch Permanet Fruit",
    Description = "",
    Default = false
});
...
local v127 = v16.Fruit:AddToggle("ToggleRandomFruit", {
    Title = "Random Trái/Random Fruit",
    Description = "",
    Default = false
});
...
local v128 = v16.Fruit:AddToggle("ToggleCollectTP", {
    Title = "Bay Đến Trái/Tween to Fruit",
    Description = "",
    Default = false
});
...
local v129 = v16.Fruit:AddToggle("ToggleCollect", {
    Title = "Dịch Chuyển Đến Trái/Collect Fruit",
    Description = "",
    Default = false
});
...
local v56 = v16.Fruit:AddSection("Định Vị/ESP");
...
local v134 = v16.Fruit:AddToggle("ToggleEspRealFruit", {
    Title = "Trái Dứa Khớm Táo/Real Fruits",
    Description = "",
    Default = false
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Đấm Quái Raid+Bay Đến Đảo/Auto Kill + Next Island",
    Description = "",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Lấy Trái Dưới 1 Triệu/Get Fruit Below 1M Money",
    Description = "",
    Default = false
});
...
if Sea2 then
    v16.Raid:AddButton({
        Title = "Bay Đến Chỗ Tập Kích/TP To Island for Raid",
        Description = "",
        Callback = function()
            Tween2(CFrame.new(- 6438.73535, 250.645355, - 4501.50684));
        end
...
local v143 = v16.Raid:AddToggle("ToggleLaw", {
    Title = "Mua Chip Và Đấm Law/Auto Law",
    Description = "",
    Default = false
});
...
v16.Race:AddButton({
    Title = "Đền Thời Gian/Temple of Time",
    Description = "",
    Callback = function()
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "Hoàn Thành Ải [Human/Ghoul]/Auto Trial[Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v145 = v16.Race:AddToggle("ToggleAutotrial", {
    Title = "Hoàn Thành Ải/Auto Trial",
    Description = "",
    Default = false
});
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "Đấm Người Chơi Trong Trial/Auto Kill Trial",
    Description = "",
    Default = false
});
...
local v147 = v16.Race:AddToggle("ToggleFarmRace", {
    Title = "Cày Luyện Tộc/Train Race",
    Description = "",
    Default = false
});
local v148 = false;
...
local v56 = v16.Shop:AddSection("Khả Năng/Skill");
v16.Shop:AddButton({
...
v16.Shop:AddButton({
    Title = "Haki Quan Sát/Observation",
    Description = "",
    Callback = function()
...
local v56 = v16.Shop:AddSection("Khác/Other");
v16.Shop:AddButton({
    Title = "Reset Chỉ Số/Refund Stats",
    Description = "",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Đổi Tộc Ghoul/Change Race to Ghoul",
    Description = "",
    Callback = function()
        local v366 = {
            [1] = "Ectoplasm",
...
v16.Shop:AddButton({
    Title = "Đổi Tộc Cyborg/Change Race to Cyborg",
    Description = "",
    Callback = function()
        local v367 = {
            [1] = "CyborgTrainer",
...
v16.Shop:AddButton({
    Title = "Đổi Tộc Rồng/Change Race to Draco",
    Description = "Chỉ Ở Biển 3/Sea 3 Only",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
...
local v56 = v16.Misc:AddSection("Đội/Team");
v16.Misc:AddButton({
    Title = "Hải Tặc/Pirates",
    Description = "",
    Callback = function()
...
v16.Misc:AddButton({
    Title = "Hải Quân/Marines",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam", "Marines");
    end
});
local v56 = v16.Misc:AddSection("Kinh Nghiệm/EXP");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = v16.Misc:AddSection("Danh Hiệu/Title");
v16.Misc:AddButton({
    Title = "Danh Hiệu/Titles",
    Description = "",
    Callback = function()
        local v378 = {
            [1] = "getTitles"
...
local v56 = v16.Misc:AddSection("Thức Tỉnh/V4");
v16.Misc:AddButton({
    Title = "Thức Tỉnh/Awake",
    Description = "",
    Callback = function()
        game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true;
    end
});
local v56 = v16.Misc:AddSection("Khác/Other");
local v151 = v16.Misc:AddToggle("ToggleRejoin", {
    Title = "Tham Gia Máy Chủ Lại/Auto Rejoin",
    Description = "",
    Default = true
});
...
local v56 = v16.Misc:AddSection("Fix Lag");
local function v152()
...
v16.Sea:AddButton({
    Title = "Mua Chip Leviathan/Buy Chip Leviathan",
    Description = "",
    Callback = function()
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Bay Đến Đảo Leviathan/Tween to Leviathan Island",
    Description = "",
    Default = false
});
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "Trạng Thái/Status Chip Leviathan",
        Content = ""
    });
    spawn(function()
        pcall(function()
...
local v157 = v16.Sea:AddToggle("ToggleBlazeEmber", {
    Title = "Lụm Lửa Đỏ/Collect Blaze Ember",
    Description = "",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "Nhận Nhiệm Vụ Lửa Đỏ/Receive Blaze Ember Quest",
...
local v159 = v16.Sea:AddParagraph({
    Title = "Trạng Thái Nhiệm Vụ Lửa Đỏ/Status Quest Blaze Ember",
    Content = ""
});
spawn(function()
    pcall(function()
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "Phá Cây Ở Đảo Hydra/Destroy Tree In Hydra Island",
    Description = "",
    Default = false
});
...
local v164 = v16.Sea:AddToggle("ToggleCollectFireFlowers", {
    Title = "Lụm Hoa Đỏ/Collect Fire Flowers",
    Description = "",
    Default = false
});
...
local v165 = v16.Sea:AddToggle("ToggleWhiteBelt", {
    Title = "Cày Đai Trắng/White Belt",
    Description = "",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Đến Cửa Trial Tộc Draco/Draco Door",
    Description = "",
    Default = false
});
...
local v168 = v16.Sea:AddSection("Đảo Dung Nham/Prehistoric Island");
...
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "Bay Đến Đảo Dung Nham/Tween to Prehistoric Island",
    Description = "",
    Default = false
});
...
local v175 = v16.Sea:AddToggle("ToggleKillAura", {
    Title = "Đấm Golems Aura/Use Golems Aura",
    Description = "",
    Default = false
});
